...
`id` int(11) NOT NULL,
  ...
  `id_user` int(11) NOT NULL,
  `refresh_error` bool NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `user` (`id`, `username`, `password`, `type`) VALUES (1, 'admin', '$2a$10$b8BhqEY9Yke1Y0MTbNxqIe0Fwz7T4U3TpshcSsRRu0GLTPyBlRl1C', 'admin')
