 ...
 */
public class SectionFeedAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private static final String         TAG = "SectionFeedAdapter";
    ...
    private static onSwitchCheckedListener     onSwitchCheckedListener;



    public SectionFeedAdapter(Context context, int sectionResourceId,
            ...
            offline.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    ...
                    if (onSwitchCheckedListener != null)
                        onSwitchCheckedListener.onCheckedChanged(isChecked);
                }
            });
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder sectionViewHolder, int position) {
        if (isSectionHeaderPosition(position)) {
            ((SectionViewHolder)sectionViewHolder).bindView(mSections.get(position));
        }else{
